                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form id="formRegist" class="" action="" method="GET">
                                <div class="row">
                                    <div style="display: flex; width: 70%;">
                                        <div class="col-xl-2 col-lg-6 col-md-12 mb-1 form-regist-school">
                                        ...
                                        <div class="tb-btn-regist">
                                            <a href="javascript:void(0)" id="btnRegist" class="btn btn-regist-school">新規登録</a>
                                        </div>
                                    </div>
                            ...
                            <form action="" id="formSearch" method="post" style="width: 414px;">
                                <div class="col-xl-2 col-lg-6 col-md-12 mb-1 form-search-school">
                                    <fieldset class="form-group">
